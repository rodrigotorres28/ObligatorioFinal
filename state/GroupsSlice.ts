  ...
  groupA: {
    ...
    matches: {
      matchA: {
        ...
        team1Id: 1,
        team2Id: 4,
        team1Goals: unplayedMatch,
        team2Goals: unplayedMatch,
      },
      matchB: {
        matchName: "matchB",
        team1Id: 2,
...
const groupsSlice = createSlice({
  ...
  reducers: {
    updateMatch(
      ...
      const isMatchPlayedBefore =
        match.team1Goals !== unplayedMatch &&
        match.team2Goals !== unplayedMatch;

      if (isMatchPlayedBefore) {
        updateTeamStats(
          group.stats[match.team1Id],
          match.team1Goals,
          match.team2Goals,
          false
        );
        updateTeamStats(
          group.stats[match.team2Id],
          match.team2Goals,
          match.team1Goals,
          false
        );
